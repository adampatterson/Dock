			...
			<div class="md-12">
				<section id="grid">
					...
					<header>
						...
						<p class="lead">Dock is a simple Bootstrap based framework made to be as non restrictive as possible. Taking a focus on layout rather than style, after all that is your job!</p>
